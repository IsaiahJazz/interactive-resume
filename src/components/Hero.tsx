...
const Hero = () => {
  return (
    <section className="flex  flex-col-reverse md:flex-row items-center justify-around px-4 py-6 gap-6 animate-fadeIn [animation-delay:0.5s] font-[roboto] min-h-[500px] bg-[linear-gradient(180deg,rgba(250,217,97,0.1),rgba(247,107,28,0.05))]">
      <div className="flex flex-col items-center md:items-start max-w-[600px] text-center md:text-left">
        ...
        <a href="/Isaiah-Nazaire-Resume.pdf" download>
          <button className="bg-white mt-5 text-[#F76B1C] font-bold px-6 py-3 rounded-full border-2 border-transparent hover:border-white hover:text-white hover:bg-gradient-to-r from-[#FAD961] to-[#F76B1C] transition">
            Download Resume
          </button>
        </a>
      </div>
